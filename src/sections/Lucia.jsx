...
const Lucia = () => {
  ...
  return (
    <section className="lucia-life">
      ...
      <div className="lg:w-1/2 lucia-lifr-content">
        <div className="max-w-xl lg:ps-32 ps-10"></div>
        <h1>Lucia Caminos </h1>
        ...
        <p>
          ...
          family landed her in the Leonida Penitentiary. Sheer luck got her out.
